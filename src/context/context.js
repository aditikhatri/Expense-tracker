...
// use locally stored data or if not give this 
...
//reducer is a fxn that defines how we will change our state so we create contextreducer
...
// we will call the functions somewhere else(form) but return them in ExpenseTrackerContext.provider for universal excess
...
// context can be used in place of redux ,wrap our application with provider and all 
//of our components will have excess to -- value property whatever is inside it
// call provider inside index.js and wrap app div inside it.
